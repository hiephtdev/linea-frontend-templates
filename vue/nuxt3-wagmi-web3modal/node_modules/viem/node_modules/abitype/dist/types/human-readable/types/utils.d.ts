import type { AbiParameter, AbiStateMutability, AbiType, SolidityFixedArrayRange } from 'viem/node_modules/abitype/src/abi.js';
import type { ResolvedConfig } from 'viem/node_modules/abitype/src/config.js';
import type { Error, IsUnknown, Merge, Pretty, Trim } from 'viem/node_modules/abitype/src/types.js';
import type { ErrorSignature, EventModifier, EventSignature, FallbackSignature, FunctionModifier, FunctionSignature, IsConstructorSignature, IsErrorSignature, IsEventSignature, IsFunctionSignature, Modifier, ReceiveSignature, Scope, ValidateName } from 'viem/node_modules/abitype/src/human-readable/types/signatures.js';
import type { StructLookup } from 'viem/node_modules/abitype/src/human-readable/types/structs.js';
