...
import type { AbiEventParametersToPrimitiveTypes, MaybeExtractEventArgsFromAbi } from 'viem/types/contract.js';
import type { IsNarrowable, IsNever, IsUndefined, Or, Prettify, UnionOmit } from 'viem/types/utils.js';
...
import { type WriteContractParameters, type WriteContractReturnType } from 'viem/actions/wallet/writeContract.js';
...
export type GetContractReturnType<TAbi extends Abi | readonly unknown[] = Abi, TPublicClient extends Client | unknown = unknown, TWalletClient extends Client | unknown = unknown, TAddress extends Address = Address, _EventNames extends string = TAbi extends Abi ? Abi extends TAbi ? string : ExtractAbiEventNames<TAbi> : string, _ReadFunctionNames extends string = TAbi extends Abi ? Abi extends TAbi ? string : ExtractAbiFunctionNames<TAbi, 'pure' | 'view'> : string, _WriteFunctionNames extends string = TAbi extends Abi ? Abi extends TAbi ? string : ExtractAbiFunctionNames<TAbi, 'nonpayable' | 'payable'> : string, _Narrowable extends boolean = IsNarrowable<TAbi, Abi>> = Prettify<(TPublicClient extends Client ? (IsNever<_ReadFunctionNames> extends true ? unknown : {
     ...
     */
    read: {
        [_FunctionName in _ReadFunctionNames]: GetReadFunction<_Narrowable, TAbi, _FunctionName>;
    };
     ...
     */
    estimateGas: {
        [_FunctionName in _WriteFunctionNames]: GetEstimateFunction<_Narrowable, TPublicClient['chain'], undefined, TAbi, _FunctionName>;
    };
    /**
     ...
     */
    simulate: {
        [_FunctionName in _WriteFunctionNames]: GetSimulateFunction<_Narrowable, TPublicClient['chain'], TAbi, _FunctionName>;
    };
     ...
     */
    createEventFilter: {
        [_EventName in _EventNames]: GetEventFilter<_Narrowable, TAbi, _EventName>;
    };
    /**
     * Creates a Filter to retrieve event logs that can be used with [`getFilterChanges`](https://viem.sh/docs/actions/public/getFilterChanges.html) or [`getFilterLogs`](https://viem.sh/docs/actions/public/getFilterLogs.html).
     *
     ...
     */
    getEvents: {
        [_EventName in _EventNames]: GetEventsFunction<_Narrowable, TAbi, _EventName>;
    };
    /**
     ...
     */
    watchEvent: {
        [_EventName in _EventNames]: GetWatchEvent<_Narrowable, TAbi, _EventName>;
    };
     ...
     */
    estimateGas: {
        [_FunctionName in _WriteFunctionNames]: GetEstimateFunction<_Narrowable, TWalletClient['chain'], TWalletClient['account'], TAbi, _FunctionName>;
    };
    /**
     ...
     */
    write: {
        [_FunctionName in _WriteFunctionNames]: GetWriteFunction<_Narrowable, TWalletClient['chain'], TWalletClient['account'], TAbi, _FunctionName>;
    };
} : unknown)> & {
    address: TAddress;
    abi: TAbi;
