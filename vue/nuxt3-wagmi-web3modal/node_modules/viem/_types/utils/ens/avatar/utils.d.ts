...
import { type ReadContractErrorType } from 'viem/actions/public/readContract.js';
...
import { type EnsAvatarInvalidMetadataErrorType, type EnsAvatarInvalidNftUriErrorType, type EnsAvatarUnsupportedNamespaceErrorType, type EnsAvatarUriResolutionErrorType } from 'viem/errors/ens.js';
import type { ErrorType } from 'viem/errors/utils.js';
import type { Chain } from 'viem/types/chain.js';
import type { AssetGatewayUrls } from 'viem/types/ens.js';
type UriItem = {
    uri: string;
    isOnChain: boolean;
    isEncoded: boolean;
