import type { AbiParameter, AbiStateMutability, AbiType, SolidityFixedArrayRange } from 'abitype/src/abi.js';
import type { ResolvedConfig } from 'abitype/src/config.js';
import type { Error, IsUnknown, Merge, Prettify, Trim } from 'abitype/src/types.js';
import type { ErrorSignature, EventModifier, EventSignature, FallbackSignature, FunctionModifier, FunctionSignature, IsConstructorSignature, IsErrorSignature, IsEventSignature, IsFunctionSignature, Modifier, ReceiveSignature, Scope, ValidateName } from 'abitype/src/human-readable/types/signatures.js';
import type { StructLookup } from 'abitype/src/human-readable/types/structs.js';
